...
class FeaturePyramidNetwork(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return [P3_x, P4_x, P5_x,P6_x,C7,C8 ]
class SimpleBlock(nn.Module):
    def __init__(self, in_planes, out_planes, BatchNorm=True, stride=1):
        super(SimpleBlock, self).__init__()
        self.conv1 = conv1x5(in_planes, out_planes, stride)
...
class SSD_ResNet(nn.Module):
    ...
    def __init__(self, phase, size, cfg, base, head, num_classes):
        ...
        self.fft_down = SimpleBlock(9, 64, True,2)
        self.relu = nn.ReLU(inplace=True)
        self.fft_down2 = SimpleBlock(64, 128, True, 2)
        self.fft_down3 = SimpleBlock(128, 256, True, 2)
        self.fft_down4 = SimpleBlock(256, 256, True, 2)
        self.fft_down5 = SimpleBlock(256, 256, True, 2)

        self.fft2_down = SimpleBlock(39, 128, True,1)
        self.fft2_down2 = SimpleBlock(128, 128, True,1)
        self.fft2_down3 = SimpleBlock(128, 256, True,2)
        self.fft2_down4 = SimpleBlock(256, 256, True,2)
        self.fft2_down5 = SimpleBlock(256, 256, True, 2)

        self.fft3_down = SimpleBlock(78, 128, True,1)
        self.fft3_down2 = SimpleBlock(128, 128, True,1)
        self.fft3_down3 = SimpleBlock(128, 256, True,1)
        self.fft3_down4 = SimpleBlock(256, 256, True,2)
        self.fft3_down5 = SimpleBlock(256, 256, True, 2)

        self.fft4_down = SimpleBlock(159, 128, True,1)
        self.fft4_down2 = SimpleBlock(128, 128, True,1)
        self.fft4_down3 = SimpleBlock(128, 256, True,1)
        self.fft4_down4 = SimpleBlock(256, 256, True,1)
        self.fft4_down5 = SimpleBlock(256, 256, True, 2)

        self.fft5_down = SimpleBlock(318, 128, True,1)
        self.fft5_down2 = SimpleBlock(128, 128, True,1)
        self.fft5_down3 = SimpleBlock(128, 256, True,1)
        self.fft5_down4 = SimpleBlock(256, 256, True,1)
        self.fft5_down5 = SimpleBlock(256, 256, True, 1)

        self.fft80_mix = SimpleBlock(256*5, 256, 1)
    ...
    def forward(self, x1,x2,x3,x4,x5):
        ...
        x1 = self.fft_down5(x1)

        x2 = self.fft2_down(x2)
        x2 = self.fft2_down2(x2)
        x2 = self.fft2_down3(x2)
        x2 = self.fft2_down4(x2)
        x2 = self.fft2_down5(x2)

        x3 = self.fft3_down(x3)
        x3 = self.fft3_down2(x3)
        x3 = self.fft3_down3(x3)
        x3 = self.fft3_down4(x3)
        x3 = self.fft3_down5(x3)

        x4 = self.fft4_down(x4)
        x4 = self.fft4_down2(x4)
        x4 = self.fft4_down3(x4)
        x4 = self.fft4_down4(x4)
        x4 = self.fft4_down5(x4)

        x5 = self.fft5_down(x5)
        x5 = self.fft5_down2(x5)
        x5 = self.fft5_down3(x5)
        x5 = self.fft5_down4(x5)
        x5 = self.fft5_down5(x5)
...
def build_SSD(phase, size, num_classes, cfg):
    ...
    base_, head_ = multibox(backbone(cfg['num_filters'],256, True, 2),
...
if __name__ == '__main__':
    ...
    x1 = torch.randn(10, 9, 4000)
    x2 = torch.randn(10, 39, 1000)
    x3 = torch.randn(10, 78, 500)
    x4 = torch.randn(10, 159, 250)
    x5 = torch.randn(10, 318, 125)
