...
class SSD_ResNet(nn.Module):
    ...
    def __init__(self, phase, size, cfg, base, head, num_classes):
        ...
        self.fft80_down_1 = conv1x3(80, 256, 1)
        self.fft80_down_2 = conv1x3(256, 256, 1)
...
def build_SSD(phase, size, num_classes, cfg):
    ...
    base_, head_ = multibox(backbone(cfg['num_filters'], 64 * 1, True, 2),
...
if __name__ == '__main__':
    cfg = {
        ...
        'num_filters': [128, 128, 128, 256, 256, 256, 512, 512, 512],
        'input_channels': 1,
        'num_scales': [6, 9, 12, 12, 12, 6],
        'min_size': [50, 100, 200, 400, 800 , 1600],
        'max_size': [100, 200, 400, 800, 1600, 2000],
        'variance': [0.1, 0.2],
        'clip': True,
        'using_gpu': True,
        'name': 'Signals',
