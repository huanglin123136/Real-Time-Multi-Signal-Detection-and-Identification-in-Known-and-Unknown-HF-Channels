...
def model_evalute_AP(net, eval_data_loader, num_data):
    ...
    conf_loss = 0
    batch_idx = 0
    for fft1, fft2, fft3, fft4, fft5, targets in  tqdm(eval_data_loader):
...
if __name__ == '__main__':
    settings = {
        ...
        'gamma': 0.25,
        'eval_model': True,
        # 'tgt_data_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_awgndata_snr_4_Npy\\traindata_1229',
        # 'tgt_label_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_awgndata_snr_4_Npy\\trainlabels_1229',
        'tgt_data_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Fd_100_snr_-8_Npy\\traindata_1229',
        'tgt_label_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Fd_100_snr_-8_Npy\\trainlabels_1229',
    ...
    print('det_p :' + ' '.join(str(c) for c in det_p) + '\n' +
          ...
          'mAP:'+str(mAP))
    sio.savemat('result_14400_Fd_100_snr_-8.mat', dict(
