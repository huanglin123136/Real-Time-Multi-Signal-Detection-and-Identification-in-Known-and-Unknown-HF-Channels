...
if __name__ == '__main__':
    ...
    for snr_i in range(len(snr)):
        snr_now = snr[snr_i]
        data_dir = 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Rayleigh_Fd_100_change_snr_'+str(snr_now)+'_Npy\\traindata_1229'
        label_dir = 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Rayleigh_Fd_100_change_snr_'+str(snr_now)+'_Npy\\trainlabels_1229'
        ...
        settings = {
            ...
            'gamma': 0.25,
            'eval_model': True,
            # 'tgt_data_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_awgndata_snr_0_new_Npy\\traindata_1229',
            # 'tgt_label_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_awgndata_snr_0_new_Npy\\trainlabels_1229',
            # 'tgt_data_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Fd_100_snr_-10_Npy\\traindata_1229',
            # 'tgt_label_dir': 'D:\\USTC\\20211230\\train_simulation_data\\20211226\\Sim_Fd_100_snr_-10_Npy\\trainlabels_1229',
            'tgt_data_dir': data_dir,
            'tgt_label_dir':label_dir,
            'resume':'.\\fft_weights\\ResNet_14400.pth',
            # eval_param
            'NMS_thre': 0.5,
            'score_thre': 0.3,
        }
        ...
        savemat = 'result_14400_rayleigh_snr_new' + str(snr_now) + '.mat'
